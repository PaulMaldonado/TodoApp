...
function () {
  function UiTask() {
    _classCallCheck(this, UiTask);
  }

  _createClass(UiTask, [{
    key: "createTask",
    value: function createTask(task) {
      var ui_task = document.getElementById('ui-task');
      var element_ui = document.createElement('div');
      element_ui.innerHTML = "\n            <div class=\"card z-depth-3\">\n                <div class=\"card-title\">\n                    <h3><span>Nombre: </span>".concat(task.name, "</h3>\n                </div>\n                <div class=\"card-content\">\n                    <p><span>Descripci\xF3n: </span>").concat(task.description, "</p>\n                </div>\n\n                <a href=\"#\" name=\"delete\" class=\"waves-effect waves-light btn-small button red darken-4\">Eliminar</a>\n                <br><br>\n            </div>\n        ");
      ui_task.appendChild(element_ui);
    }
  }, {
    key: "clearForm",
    value: function clearForm() {
      var clear_form = document.getElementById('todo-task');
      clear_form.reset();
    }
  }, {
    key: "deleteTask",
    value: function deleteTask(element_ui) {
...
document.getElementById('todo-task').addEventListener('submit', function (e) {
  ...
  var tasks = new Task(name, description);
  var task_ui = new UiTask();
  task_ui.createTask(tasks);
  task_ui.clearForm();
  e.preventDefault();
  var todo_delete = document.getElementById('ui-task');
